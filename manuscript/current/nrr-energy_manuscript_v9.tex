...
\title{\textbf{NRR-Energy: Calibration of Commit/Defer Utility\\Under Existing Paired Boundary Data}}
...
\begin{enumerate}
  \item A reproducible calibration procedure for an Energy-style commit/defer utility instrument under existing paired Boundary data.
...
These inputs were copied from the Boundary workspace snapshot on branch \texttt{main} at HEAD \texttt{4cbb80c}.
